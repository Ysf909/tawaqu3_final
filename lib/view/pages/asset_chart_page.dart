...
class _AssetChartViewState extends State<AssetChartView> {
  ...
  Future<void> _fetchCandles() async {
    await _ws?.requestCandles(_symbol, _tf, limit: 800);
    if (!mounted) return;
    _refreshCandles();
    setState(() {
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => const [
              ...
              PopupMenuItem(value: "30m", child: Text("30m")),
              PopupMenuItem(value: "1h", child: Text("1h")),
              PopupMenuItem(value: "4h", child: Text("4h")),
              PopupMenuItem(value: "1d", child: Text("1d")),
            ],
          ),
        ],
      ),
